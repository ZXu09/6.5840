...
func call(rpcname string, args interface{}, reply interface{}) bool {
	...
	// if coordinator.done(all the task finish), the main func in mrcoordinator.go will exit,
	// so the http.Serve() of coordinator will close, and the client read nothing and raise unexpected EOF.
	DPrintf("%+v", err)
	return false
}
